...
public class KechengpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengpingjiaEntity kechengpingjia, 
		...
		if(tableName.equals("shangjia")) {
			kechengpingjia.setShangjiazhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			kechengpingjia.setZhanghao((String)request.getSession().getAttribute("username"));
		}

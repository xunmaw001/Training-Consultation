<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程人数" prop="kechengrenshu">
          <el-input v-model="ruleForm.kechengrenshu" 
              placeholder="课程人数" clearable  :readonly="ro.kechengrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程人数" prop="kechengrenshu">
              <el-input v-model="ruleForm.kechengrenshu" 
                placeholder="课程人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程老师" prop="kechenglaoshi">
          <el-input v-model="ruleForm.kechenglaoshi" 
              placeholder="课程老师" clearable  :readonly="ro.kechenglaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程老师" prop="kechenglaoshi">
              <el-input v-model="ruleForm.kechenglaoshi" 
                placeholder="课程老师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='kechengrenshu'){
            this.ruleForm.kechengrenshu = obj[o];
	    this.ro.kechengrenshu = true;
            continue;
          }
          if(o=='jiage'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='kechenglaoshi'){
            this.ruleForm.kechenglaoshi = obj[o];
	    this.ro.kechenglaoshi = true;
            continue;
          }
          if(o=='kechengjieshao'){
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../ssm1x9di/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

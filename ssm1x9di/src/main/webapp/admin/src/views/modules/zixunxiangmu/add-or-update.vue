<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询类别" prop="zixunleibie">
          <el-input v-model="ruleForm.zixunleibie" 
              placeholder="咨询类别" clearable  :readonly="ro.zixunleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询类别" prop="zixunleibie">
              <el-input v-model="ruleForm.zixunleibie" 
                placeholder="咨询类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询时长" prop="zixunshizhang">
          <el-input v-model="ruleForm.zixunshizhang" 
              placeholder="咨询时长" clearable  :readonly="ro.zixunshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询时长" prop="zixunshizhang">
              <el-input v-model="ruleForm.zixunshizhang" 
                placeholder="咨询时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询对象" prop="zixunduixiang">
          <el-input v-model="ruleForm.zixunduixiang" 
              placeholder="咨询对象" clearable  :readonly="ro.zixunduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询对象" prop="zixunduixiang">
              <el-input v-model="ruleForm.zixunduixiang" 
                placeholder="咨询对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="项目收费" prop="xiangmushoufei">
          <el-input v-model="ruleForm.xiangmushoufei" 
              placeholder="项目收费" clearable  :readonly="ro.xiangmushoufei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="项目收费" prop="xiangmushoufei">
              <el-input v-model="ruleForm.xiangmushoufei" 
                placeholder="项目收费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="咨询师介绍" prop="zixunshijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="咨询师介绍"
                  v-model="ruleForm.zixunshijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zixunshijieshao" label="咨询师介绍" prop="zixunshijieshao">
                    <span>{{ruleForm.zixunshijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangmujieshao = this.ruleForm.xiangmujieshao.replace(reg,'../../../ssm1x9di/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zixunxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zixunxiangmuCrossAddOrUpdateFlag = false;
                  this.parent.search();
